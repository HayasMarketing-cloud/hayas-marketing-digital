...
const slides: Slide[] = [
  {
    ...
    isH1: true,
    useDynamicH1: true,
    titleEs: 'Activa el crecimiento de tu negocio con un sistema, no con servicios',
    titleEn: 'Activate your business growth with a system, not services',
    subtitleEs: 'SENSE define la estrategia. Hayas la convierte en resultados.',
    subtitleEn: 'SENSE defines the strategy. Hayas turns it into results.',
    badgeEs: 'Marketing Activation System',
    badgeEn: 'Marketing Activation System',
    ctaEs: 'Ver cómo funciona',
