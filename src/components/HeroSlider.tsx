...
const slides: Slide[] = [
  {
    ...
    subtitleEs: 'Conectamos estrategia, datos y ejecución en un sistema propio para que tu marketing funcione con criterio, no con improvisación.',
    subtitleEn: 'We connect strategy, data and execution into a proprietary system so your marketing runs on insight, not improvisation.',
    badgeEs: 'Marketing + Inteligencia de datos',
    badgeEn: 'Marketing + Data Intelligence',
    ctaEs: undefined,
    ctaEn: undefined,
    hrefEs: undefined,
    hrefEn: undefined,
