...
const slides: Slide[] = [
  {
    ...
    isH1: true,
    useDynamicH1: true,
    titleEs: 'SENSE by Hayas',
    titleEn: 'SENSE by Hayas',
    subtitleEs: 'El sistema que transforma cómo las empresas entienden el mercado, toman decisiones y activan su marketing.',
    subtitleEn: 'The system that transforms how companies understand the market, make decisions, and activate their marketing.',
    badgeEs: 'Marketing Operating System',
    badgeEn: 'Marketing Operating System',
    ctaEs: 'Explorar SENSE',
    ctaEn: 'Explore SENSE',
    hrefEs: '/es/soluciones/plataforma-inteligencia-marketing',
    hrefEn: '/en/solutions/marketing-intelligence-platform',
