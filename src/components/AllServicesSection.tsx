  ...
  return (
    <section id="todos-servicios" className="py-8 md:py-12 bg-white">
      <div className="container mx-auto px-4">
        ...
        <div
          className={`grid ${view === 'grid' ? 'grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8' : 'grid-cols-1 gap-6'} animate-fade-in`}
        >
          {filtered.map((service, idx) => {
            const initiallyVisible =
              active === 'all' ? isPreferred(service.title, service.href) : idx < 6;
