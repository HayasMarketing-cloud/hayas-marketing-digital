...
const getPageMessage = (pathname: string) => {
  const messages: { [key: string]: string } = {
    ...
    '/es/activaciones/research': '¡Hola! ¿Interesado en inteligencia de mercado e IA? Te ayudo con consultoría estratégica y herramientas de IA.',
    '/es/activaciones/growth': '¡Hola! ¿Buscas captar más leads cualificados? Te cuento cómo funciona nuestra activación de crecimiento.',
    '/es/activaciones/visibility': '¡Hola! ¿Quieres mejorar tu visibilidad online? Te explico nuestras estrategias de SEO, Ads y redes sociales.',
    '/es/activaciones/web-funnel': '¡Hola! ¿Necesitas una web que convierta? Te ayudo con diseño web, tiendas online y funnels.',
    '/es/activaciones/crm-automation': '¡Hola! ¿Quieres automatizar tus ventas? Te explico cómo implementar CRM y automatizaciones.',
    '/es/activaciones/content-brand': '¡Hola! ¿Necesitas una marca que conecte? Te ayudo con branding, contenidos y localización.',
    // English pages
...
const getPageHelpMessage = (pathname: string) => {
  const helpMessages: { [key: string]: string } = {
    ...
    '/es/activaciones/research': '¿Necesitas inteligencia de mercado o integrar IA en tu marketing?',
    '/es/activaciones/growth': '¿Buscas generar más leads cualificados para tu negocio?',
    '/es/activaciones/visibility': '¿Quieres mejorar tu posicionamiento en Google y redes sociales?',
    '/es/activaciones/web-funnel': '¿Necesitas una web profesional o un funnel de conversión?',
    '/es/activaciones/crm-automation': '¿Quieres automatizar tu proceso de ventas con un CRM?',
    '/es/activaciones/content-brand': '¿Necesitas una marca diferenciadora o contenido estratégico?',
    // English pages
