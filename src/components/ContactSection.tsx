...
const ContactSection = () => {
  return (
    <section id="contacto" className="py-8 md:py-12 bg-gray-50">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">¿Listo para potenciar tu negocio?</h2>
            ...
            <div className="space-y-8">
              ...
              <div className="pt-6 mt-6 border-t border-gray-200">
                ...
                <div className="flex gap-4 mt-4">
                  <a href="https://www.linkedin.com/company/hayasmarketing/" className="h-10 w-10 rounded-full bg-hayas-100 hover:bg-hayas-200 flex items-center justify-center transition-colors" target="_blank" rel="noopener noreferrer">
                    <svg className="h-5 w-5 text-hayas-800" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                      <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
                    </svg>
                  </a>
                  <a href="https://www.instagram.com/hayas_marketing/" className="h-10 w-10 rounded-full bg-hayas-100 hover:bg-hayas-200 flex items-center justify-center transition-colors" target="_blank" rel="noopener noreferrer">
                    <svg className="h-5 w-5 text-hayas-800" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
