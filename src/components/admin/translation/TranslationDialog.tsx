...
export const TranslationDialog: React.FC<TranslationDialogProps> = ({ pair, onClose }) => {
  ...
  const dialog = t('admin.dialog') as any;
      ...
      <DialogContent className="max-w-2xl">
        ...
        <div className="space-y-6 py-4">
          ...
          <div className="space-y-2">
            <Label>{dialog.originalPage}</Label>
          ...
          <div className="space-y-2">
            <Label>{dialog.suggestedSlug}</Label>
            ...
            <p className="text-xs text-muted-foreground">
              {dialog.autoGenerated}
            </p>
          </div>

          {/* Custom Slug Option */}
          <div className="space-y-2">
            <Label htmlFor="custom-slug">{dialog.customSlug}</Label>
            <Input
              id="custom-slug"
