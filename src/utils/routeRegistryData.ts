...
export const registeredRoutes: RouteDefinition[] = [
  ...
  { path: '/en/case-studies/i-virgen-extra', category: 'case-study', isIndexable: false, priority: 0.5, changefreq: 'monthly', isDynamic: false, isLegacy: false },
  ...
  { path: '/en/case-studies/calisthenics-online', category: 'case-study', isIndexable: false, priority: 0.5, changefreq: 'monthly', isDynamic: false, isLegacy: false },
  { path: '/en/case-studies/centro-roraima', category: 'case-study', isIndexable: false, priority: 0.5, changefreq: 'monthly', isDynamic: false, isLegacy: false },
  { path: '/en/case-studies/joints-up', category: 'case-study', isIndexable: false, priority: 0.5, changefreq: 'monthly', isDynamic: false, isLegacy: false },
