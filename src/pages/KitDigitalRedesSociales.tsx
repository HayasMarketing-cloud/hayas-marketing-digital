  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <ServiceContactSection
        ...
        title="Solicita tu asesoría gratuita para Redes Sociales Kit Digital"
        subtitle="Te ayudamos con todo el proceso: desde la solicitud del bono hasta la gestión completa de tus redes sociales."
        minHeight={820}
      />
