        ...
        <section className="py-16 bg-muted/30">
          <div className="container mx-auto px-4 max-w-5xl">
            ...
            <blockquote className="mt-8 border-l-2 pl-4 text-muted-foreground italic">
              “Ahora podemos gestionar la información de cada cliente de forma centralizada y detectar más oportunidades para ofrecer un servicio integral.” — Dirección, ALFIX Consultores.
            </blockquote>
          </div>
        </section>
