        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">
              Solicita tu asesoría gratuita para CRM Kit Digital
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Te ayudamos con todo el proceso: desde la solicitud del bono hasta la implementación completa de tu CRM.
            </p>
          </div>
          <div className="max-w-2xl mx-auto">
            <NativeServiceForm sourcePage="kit-digital-gestion-clientes" />
          </div>
        </div>
      </section>
