              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
                <Card className="text-center border-none shadow-lg">
                  <CardContent className="p-6">
                    <div className="text-3xl font-bold text-hayas-600 mb-2">+400%</div>
                    <p className="text-gray-600">Aumento en solicitudes de servicios</p>
                  </CardContent>
                </Card>
                <Card className="text-center border-none shadow-lg">
                  <CardContent className="p-6">
                    <div className="text-3xl font-bold text-turquesa-600 mb-2">60%</div>
                    <p className="text-gray-600">Reducción en tiempo de gestión</p>
                  </CardContent>
                </Card>
                <Card className="text-center border-none shadow-lg">
                  <CardContent className="p-6">
                    <div className="text-3xl font-bold text-hayas-600 mb-2">95%</div>
                    <p className="text-gray-600">Satisfacción de estudiantes</p>
                  </CardContent>
                </Card>
              </div>
              ...
              <Card className="border-none shadow-lg bg-gradient-to-br from-hayas-50 to-turquesa-50">
                <CardContent className="p-8">
                  <blockquote className="text-lg italic text-gray-700 mb-4 text-center">
                    "La nueva plataforma digital ha revolucionado nuestra forma de atender a los estudiantes. 
                    Ahora ofrecemos una experiencia completa y automatizada que nos ha convertido en la 
                    referencia para estudiantes internacionales que vienen a España."
                  </blockquote>
                  <div className="text-center">
                    <p className="font-semibold text-hayas-600">- Director de Inbound Students</p>
                  </div>
                </CardContent>
              </Card>
            </div>
