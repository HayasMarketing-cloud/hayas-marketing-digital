...
import { Search, BarChart3, FileText, Target, ArrowRight, CheckCircle, TrendingUp, Users, Globe, Settings, MessageSquare, Bot, Brain, Zap, AlertCircle, Sparkles, Eye } from 'lucide-react';
const SeoPositioning = () => {
  ...
  const content = {
    ...
    paradigmTitle: isEnglish ? 'Why traditional SEO is <span class="text-gradient-primary">no longer enough</span>' : 'Por qué el SEO tradicional <span class="text-gradient-primary">ya no es suficiente</span>',
    paradigmPoints: isEnglish ? [{
      icon: <MessageSquare className="h-6 w-6" />,
      title: 'Users now converse',
      description: 'They don\'t just search keywords, they ask questions to AI assistants.'
    }, {
      ...
      description: 'Many decisions are made before visiting your website, in AI-generated responses.'
    }] : [{
      icon: <MessageSquare className="h-6 w-6" />,
      title: 'Los usuarios ahora conversan',
      description: 'Ya no solo buscan keywords, hacen preguntas a asistentes de IA.'
    }, {
      icon: <Brain className="h-6 w-6" />,
      ...
      description: 'Muchas decisiones se toman antes de visitar tu web, en respuestas generadas por IA.'
    }],
    paradigmCallout: isEnglish ? 'If your brand isn\'t structured for AI, you don\'t exist in that invisible phase of the funnel.' : 'Si tu marca no está estructurada para IA, no existe en esa fase invisible del funnel.',
    // SEO vs AEO vs GEO section
    comparisonBadge: isEnglish ? 'The Three Pillars' : 'Los Tres Pilares',
    comparisonTitle: isEnglish ? 'SEO + AEO + GEO: <span class="text-gradient-primary">Complete visibility strategy</span>' : 'SEO + AEO + GEO: <span class="text-gradient-primary">Estrategia de visibilidad completa</span>',
    comparisonSubtitle: isEnglish ? 'Three complementary approaches that work together to maximize your digital presence.' : 'Tres enfoques complementarios que trabajan juntos para maximizar tu presencia digital.',
    pillars: isEnglish ? [{
    ...
    benefitsTitle: isEnglish ? 'What your company <span class="text-gradient-primary">gains</span>' : 'Qué <span class="text-gradient-primary">gana</span> tu empresa',
    benefitsSubtitle: isEnglish ? 'Tangible results from combining SEO + AEO + GEO in your visibility strategy.' : 'Resultados tangibles de combinar SEO + AEO + GEO en tu estrategia de visibilidad.',
    benefits: isEnglish ? [{
      icon: <Bot className="h-5 w-5" />,
      text: 'Appear in ChatGPT and Copilot responses'
    }, {
      icon: <Sparkles className="h-5 w-5" />,
      text: 'Be cited as an expert source'
    }, {
      icon: <Target className="h-5 w-5" />,
      text: 'Influence decisions before price comparison'
    }, {
      icon: <TrendingUp className="h-5 w-5" />,
      text: 'Reduce dependence on purely organic traffic'
    }, {
      icon: <Eye className="h-5 w-5" />,
      text: 'Prepare your web for AI agents that browse and act'
    }, {
      icon: <Globe className="h-5 w-5" />,
      text: 'Stay visible in Google and Bing'
    }] : [{
      icon: <Bot className="h-5 w-5" />,
      text: 'Aparecer en respuestas de ChatGPT y Copilot'
    }, {
      icon: <Sparkles className="h-5 w-5" />,
      text: 'Ser citado como fuente experta'
    }, {
      icon: <Target className="h-5 w-5" />,
      text: 'Influir en decisiones antes de que comparen precios'
    }, {
      icon: <TrendingUp className="h-5 w-5" />,
      text: 'Reducir dependencia del tráfico puramente orgánico'
    }, {
      icon: <Eye className="h-5 w-5" />,
      text: 'Preparar la web para agentes IA que navegan y actúan'
    }, {
      icon: <Globe className="h-5 w-5" />,
      text: 'Mantener visibilidad en Google y Bing'
    }],
    // Services included - reformulated
    servicesTitle: isEnglish ? 'What we <span class="text-gradient-primary">include</span>' : 'Qué <span class="text-gradient-primary">incluye</span>',
    servicesSubtitle: isEnglish ? 'Services focused on results, not just activities.' : 'Servicios enfocados en resultados, no solo en actividades.',
    services: isEnglish ? [{
    ...
    processSubtitle: isEnglish ? 'A four-phase approach that builds from solid foundations to AI authority.' : 'Un enfoque en cuatro fases que construye desde fundamentos sólidos hasta autoridad en IA.',
    // CTA - NEW
  ...
  return <div className="min-h-screen bg-white">
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight" dangerouslySetInnerHTML={{
              __html: content.heroTitle
            }} />
      ...
      <section className="py-16 md:py-20 bg-gradient-to-br from-primary/10 via-accent/5 to-primary/10">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-4" dangerouslySetInnerHTML={{
            __html: content.paradigmTitle
          }} />
          </div>
          
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            {content.paradigmPoints.map((point, index) => <Card key={index} className="border-none shadow-lg bg-white/80 backdrop-blur">
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-4" dangerouslySetInnerHTML={{
            __html: content.comparisonTitle
          }} />
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {content.pillars.map((pillar, index) => <Card key={index} className={`border-2 ${index === 1 ? 'border-accent shadow-xl scale-105' : 'border-gray-200'} hover:shadow-xl transition-all duration-300`}>
                ...
                <CardContent>
                  ...
                  <div className="space-y-3">
                    {pillar.results.map((result, idx) => <div key={idx} className="flex items-center gap-3">
      ...
      <section className="py-16 md:py-20 bg-gradient-to-br from-gray-50 to-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
            {content.benefits.map((benefit, index) => <div key={index} className="flex items-center gap-4 p-4 bg-white rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {content.services.map((service, index) => <Card key={index} className="border-none shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 h-full">
      ...
      {/* Contact Section */}
      <ServiceContactSection title={content.contactTitle} subtitle={content.contactSubtitle} />
