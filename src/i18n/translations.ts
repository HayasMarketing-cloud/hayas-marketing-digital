  ...
  es: {
    ...
    admin: {
      translationManager: {
        ...
        subtitle: 'Gestiona las traducciones de contenido y monitorea el progreso',
        tabs: {
          translations: 'Traducciones',
          inconsistencies: 'Detector de Inconsistencias'
        }
      },
      stats: {
      ...
      table: {
        title: 'Páginas y Traducciones',
        search: 'Buscar por título o ruta...',
        filters: {
          status: 'Estado',
          category: 'Categoría',
          all: 'Todas'
      ...
      dialog: {
        title: 'Traducir página al inglés',
        subtitle: 'Los metadatos SEO y el contenido traducido se generarán automáticamente',
        originalPage: 'Página original (ES)',
        suggestedSlug: 'Slug sugerido (EN)',
        customSlug: 'Personalizar slug (opcional)',
        autoGenerated: 'Generado automáticamente según reglas de traducción',
        syncStatus: 'Estado de Sincronización',
        checklist: {
          title: 'Lista de verificación de traducción',
          appTsx: 'Ruta definida en App.tsx',
          registry: 'Entrada en routeRegistryData.ts',
          database: 'Se creará en seo_pages (BD)',
          willBeCreated: 'Se creará automáticamente'
        },
        alerts: {
          missingInApp: {
            title: '⚠️ La ruta no existe en App.tsx',
            description: 'Debes agregar esta ruta antes de traducir:',
            code: 'Agrega este código en src/App.tsx:'
          },
          missingInRegistry: {
            title: 'ℹ️ Falta registro en routeRegistryData.ts',
            description: 'Después de traducir, agrega esta entrada:',
            code: 'Agrega este código en src/utils/routeRegistryData.ts:'
          },
          ready: {
            title: '✅ Listo para traducir',
            description: 'La ruta existe en App.tsx y routeRegistryData.ts'
          }
        },
        buttons: {
          cancel: 'Cancelar',
      ...
      inconsistencies: {
        ...
        subtitle: 'Compara rutas EN entre App.tsx, routeRegistryData.ts y seo_pages (BD)',
        summary: {
          errors: 'Errores',
        ...
        howTo: {
          ...
          errorItem: 'Errores (rojo): Requieren acción inmediata',
          warningItem: 'Advertencias (amarillo): Inconsistencias menores',
          completeItem: 'Completo (verde): Rutas correctamente sincronizadas'
        },
        sources: {
          app: 'App.tsx',
          registry: 'routeRegistryData.ts',
          database: 'seo_pages (BD)'
        },
        issues: {
          complete: 'Completo ✓',
          missing_in_app: 'Falta en App.tsx',
          missing_in_registry: 'Falta en routeRegistryData.ts',
          missing_in_db: 'Falta en seo_pages (BD)',
          orphan_in_registry: 'Huérfana en routeRegistryData.ts',
          orphan_in_db: 'Huérfana en BD (sin ruta en código)'
        },
        descriptions: {
          complete: 'La ruta existe en todos los sistemas',
          missing_in_app: 'La ruta existe en BD y registro pero no en App.tsx - Agrégala al código',
          missing_in_registry: 'La ruta existe en App.tsx y BD pero no en routeRegistryData.ts',
          missing_in_db: 'La ruta existe en código pero no tiene datos SEO en la base de datos',
          orphan_in_registry: 'La ruta está en routeRegistryData.ts pero no existe en App.tsx ni en BD',
          orphan_in_db: 'La ruta tiene datos SEO en BD pero no existe en código'
        },
        solution: 'Solución',
    ...
    faq: {
      ...
      home: {
        q1: '¿Qué es SENSE y cómo funciona?',
        a1: 'SENSE es nuestro Marketing Operating System: un sistema que conecta identidad, mercado, demanda, estrategia y ejecución en un flujo continuo de inteligencia.\n\nA diferencia de una agencia tradicional que ejecuta acciones aisladas, SENSE organiza todo el marketing de tu empresa en 4 pilares de ejecución — Revenue, Intelligence, Visibility y Content — para que cada decisión tenga contexto, cada acción tenga propósito y cada resultado sea medible.',
        q2: '¿Qué son los 4 pilares de SENSE?',
        a2: 'Los 4 pilares son los dominios de ejecución dentro de SENSE:\n\n• Revenue: CRM, automatización de ventas, captación de leads y gestión comercial.\n• Intelligence: Analítica, consultoría estratégica, inteligencia de mercado e IA aplicada.\n• Visibility: SEO, posicionamiento en buscadores y motores de IA, publicidad digital y presencia en redes.\n• Content: Estrategia de contenidos, branding, diseño web y localización multilingüe.\n\nCada pilar resuelve un problema concreto y todos están conectados dentro del sistema.',
        q3: '¿SENSE es para empresas B2B, B2C o ambas?',
        a3: 'Ambas. SENSE se adapta al tipo de negocio, al proceso de decisión y al momento de la empresa.\n\nEn B2B trabajamos con ciclos de venta largos donde la estrategia, el contenido y la gestión de clientes son clave. En B2C, el foco suele estar en captación, conversión y eficiencia operativa.\n\nEn ambos casos, analizamos primero la situación y activamos los pilares más relevantes.',
        q4: '¿Puedo activar solo un pilar o necesito el sistema completo?',
        a4: 'Puedes empezar por el pilar que más necesites. SENSE es modular: puedes activar Revenue para ordenar tu gestión comercial, Visibility para mejorar tu posicionamiento, o cualquier combinación.\n\nLo importante es que cada pilar funciona dentro de un sistema coherente, así que a medida que crezcas, puedes ir incorporando más capacidades sin perder la visión de conjunto.',
        q5: '¿Cuánto tiempo toma ver resultados con SENSE?',
        a5: 'Depende del pilar y el alcance:\n\n• Revenue (CRM y automatizaciones): eficiencias inmediatas desde el primer mes.\n• Visibility (campañas publicitarias): primeros resultados en 2-4 semanas.\n• Visibility (SEO y posicionamiento orgánico): resultados sólidos entre 3-6 meses.\n• Content e Intelligence: impacto progresivo y acumulativo desde el inicio.\n\nEl sistema está diseñado para generar valor incremental: cada mes suma sobre lo anterior.',
        q6: '¿Cómo se integra SENSE con nuestro equipo interno?',
        a6: 'SENSE se adapta a tu estructura. Podemos operar como tu departamento de marketing externo, colaborar con tu equipo existente, o proporcionarte consultoría y formación para que gestionen el sistema internamente.\n\nEl objetivo es que tu empresa tenga un sistema de marketing gobernable, no dependencia de una agencia.'
      }
    },
    marketingChanged: {
      // Bloque 1 — Cambio de paradigma
      paradigmTitle: 'El problema no es hacer marketing.',
      paradigmHighlight: '',
      paradigmIntro: 'Es no saber qué hacer, cuándo hacerlo y por qué.',
      paradigmPoints: [
        'Datos sin contexto',
        'Herramientas desconectadas',
        'Acciones sin criterio'
      ],
      paradigmConclusion: 'Mucho esfuerzo, poca claridad.',
      // Bloque 2 — Reposicionamiento
      repoTitle: 'No hacemos marketing como servicio.',
      repoHighlight: ' Construimos sistemas de decisión.',
      repoDescription: 'SENSE es el sistema que conecta identidad, mercado, demanda, estrategia y ejecución en un flujo continuo de inteligencia.',
      repoCta: 'Explorar SENSE',
      // Bloque 3 — Los 5 módulos
      modulesTitle: 'Un sistema conectado, no herramientas aisladas',
      modulesSubtitle: 'SENSE opera a través de 5 capas de inteligencia que trabajan juntas:',
      modules: {
        brain: {
          name: 'BRAIN',
          title: 'Identidad y posicionamiento',
          description: 'Define quién eres, qué te diferencia y cómo debe percibirse tu marca en el mercado.'
        },
        radar: {
          name: 'RADAR',
          title: 'Señales del mercado',
          description: 'Detecta tendencias, movimientos de competencia y oportunidades antes que otros.'
        },
        search: {
          name: 'SEARCH',
          title: 'Demanda y visibilidad',
          description: 'Identifica qué busca tu audiencia y posiciona tu marca donde importa: buscadores, IA y conversaciones.'
        },
        strategy: {
          name: 'STRATEGY',
          title: 'Decisiones estratégicas',
          description: 'Transforma datos y señales en decisiones claras con criterio, no con intuición.'
        },
        plans: {
          name: 'PLANS',
          title: 'Ejecución con foco',
  ...
  en: {
    ...
    admin: {
      translationManager: {
        ...
        subtitle: 'Manage content translations and monitor progress',
        tabs: {
          translations: 'Translations',
          inconsistencies: 'Inconsistency Detector'
        }
      },
      stats: {
      ...
      table: {
        title: 'Pages and Translations',
        search: 'Search by title or path...',
        filters: {
          status: 'Status',
          category: 'Category',
          all: 'All'
      ...
      dialog: {
        ...
        subtitle: 'SEO metadata and translated content will be generated automatically',
        originalPage: 'Original page (ES)',
        suggestedSlug: 'Suggested slug (EN)',
        customSlug: 'Customize slug (optional)',
        autoGenerated: 'Automatically generated according to translation rules',
        syncStatus: 'Synchronization Status',
        checklist: {
          title: 'Translation Checklist',
          appTsx: 'Route defined in App.tsx',
          registry: 'Entry in routeRegistryData.ts',
          database: 'Will be created in seo_pages (DB)',
          willBeCreated: 'Will be created automatically'
        },
        alerts: {
          missingInApp: {
            title: '⚠️ Route does not exist in App.tsx',
            description: 'You must add this route before translating:',
            code: 'Add this code in src/App.tsx:'
          },
          missingInRegistry: {
            title: 'ℹ️ Missing registration in routeRegistryData.ts',
            description: 'After translating, add this entry:',
            code: 'Add this code in src/utils/routeRegistryData.ts:'
          },
          ready: {
            title: '✅ Ready to translate',
            description: 'Route exists in App.tsx and routeRegistryData.ts'
          }
        },
        buttons: {
          cancel: 'Cancel',
      ...
      inconsistencies: {
        ...
        subtitle: 'Compare EN routes between App.tsx, routeRegistryData.ts and seo_pages (DB)',
        summary: {
          errors: 'Errors',
          warnings: 'Warnings',
          complete: 'Complete'
        ...
        howTo: {
          ...
          errorItem: 'Errors (red): Require immediate action',
          warningItem: 'Warnings (yellow): Minor inconsistencies',
          completeItem: 'Complete (green): Routes correctly synchronized'
        },
        sources: {
          app: 'App.tsx',
          registry: 'routeRegistryData.ts',
          database: 'seo_pages (DB)'
        },
        issues: {
          complete: 'Complete ✓',
          missing_in_app: 'Missing in App.tsx',
          missing_in_registry: 'Missing in routeRegistryData.ts',
          missing_in_db: 'Missing in seo_pages (DB)',
          orphan_in_registry: 'Orphan in routeRegistryData.ts',
          orphan_in_db: 'Orphan in DB (no code route)'
        },
        descriptions: {
          complete: 'Route exists in all systems',
          missing_in_app: 'Route exists in DB and registry but not in App.tsx - Add it to the code',
          missing_in_registry: 'Route exists in App.tsx and DB but not in routeRegistryData.ts',
          missing_in_db: 'Route exists in code but has no SEO data in database',
          orphan_in_registry: 'Route is in routeRegistryData.ts but does not exist in App.tsx or DB',
          orphan_in_db: 'Route has SEO data in DB but does not exist in code'
        },
        solution: 'Solution',
