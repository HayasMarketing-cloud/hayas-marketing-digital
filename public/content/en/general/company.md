...
- **Canonical URL**: https://hayasmarketing.com/en/about-us
...
- **RADAR**: Market intelligence — continuous industry and competitor monitoring
- **SEARCH**: Visibility & intent — keyword tracking and AI brand perception
- **STRATEGY**: Strategic direction — drivers, directives and coherence scoring
...
**URL**: /en/activations/research

### Growth Activation
Inbound marketing, lead generation, direct marketing and funnel implementation.
**URL**: /en/activations/growth

### Visibility Activation
SEO, Google Ads advertising, social media advertising and management.
**URL**: /en/activations/visibility

### Web & Funnel Activation
Professional web design, online stores, conversion funnels and hosting.
**URL**: /en/activations/web-funnel

### CRM & Automation Activation
CRM implementation (HubSpot, GHL), sales automation, email marketing and CRM administration.
**URL**: /en/activations/crm-automation

### Content & Brand Activation
Brand creation, content strategy and multilingual localization.
**URL**: /en/activations/content-brand

## Team

- **8 specialized professionals** in Digital Marketing, CRM, AI, SEO, Web Design, and Automation
- **Continuous training** in latest technologies and trends
...
- **HubSpot Partner**: CRM implementation and optimization
- **Google Partner**: Advertising and analytics
- **Meta Business Partner**: Social media campaigns
- **Lovable Partner**: AI-powered web development
- **Shopify Partner**: E-commerce
- **Aircall Partner**: Integrated telephony
...
15+ documented cases across fintech, tourism, e-commerce, healthcare, education, and professional services. Featured clients: FINECT, Asendia, BuhoBike, Wooptix, Joints Up, Alma Cruceros, Nova Praxis, Peris Electricidad, and more.

### Typical Results
- Qualified lead increase between 40-200%
- Customer acquisition cost reduction between 25-50%
- CRM implementation in 4-8 weeks
- Positive ROI from the first quarter

## Client Reviews

- **Google Business**: 5.0/5 stars (18+ verified reviews)
- Clients highlight: personalized attention, measurable results, team training, and professionalism
- **Reviews URL**: https://www.google.com/search?q=opiniones+de+hayas+marketing
...
https://hayasmarketing.com/en/about-us